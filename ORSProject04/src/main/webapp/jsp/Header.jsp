...
<nav class="navbar navbar-expand-lg navbar-dark py-0"
		...
		<div class="collapse navbar-collapse" id="mainNav">
			...
			<ul class="navbar-nav me-auto gap-0">
				...
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle px-3 py-3" href="#"
					data-bs-toggle="dropdown" aria-expanded="false"> <i
						class="bi bi-building me-1"></i> Daily Module
				</a>

					<ul
						class="dropdown-menu dropdown-menu-dark shadow border-0 rounded-3"
						style="min-width: 220px; background: #1a2e4a;">
						...
						<li><a class="dropdown-item"
							href="<%=ORSView.COLLEGE_RECORD_CTL%>"> <i
								class="bi bi-plus-circle me-2 text-success"></i> Add College
								Record
						</a></li>
						<li><a class="dropdown-item"
							href="<%=ORSView.COLLEGE_RECORD_LIST_CTL%>"> <i
								class="bi bi-list-ul me-2 text-primary"></i> College Record List
						</a></li>
						...
						<%-- <li>
							<h6 class="dropdown-header text-uppercase text-info small">
								<i class="bi bi-building me-1"></i> Department Manage
							</h6>
						</li>

						<li><a class="dropdown-item"
							href="<%=ORSView.DEPARTMENT_CTL%>"> <i
								class="bi bi-plus-circle me-2 text-success"></i> Add Department
						</a></li>
						<li><a class="dropdown-item"
							href="<%=ORSView.DEPARTMENT_LIST_CTL%>"> <i
								class="bi bi-building me-2 text-success"></i> Department List
						</a></li> --%>

						<%-- <li>
							<h6 class="dropdown-header text-uppercase text-info small">
								<i class="bi bi-book me-1"></i> Course Detail Manage
							</h6>
						</li>

						<li><a class="dropdown-item"
							href="<%=ORSView.COURSE_MODULE_CTL%>"> <i
								class="bi bi-plus-circle me-2 text-success"></i> Add Course
								Detail
						</a></li>

						<li><a class="dropdown-item"
							href="<%=ORSView.COURSE_MODULE_LIST_CTL%>"> <i
								class="bi bi-book me-2 text-success"></i> Course Detail List
						</a></li> --%>
						...
						<li><a class="dropdown-item" href="<%=ORSView.EVENT_CTL%>">
								<i class="bi bi-plus-circle me-2 text-success"></i> Add Event
						</a></li>
				...
				<%-- <li>
							<h6 class="dropdown-header text-uppercase text-info small">
								<i class="bi bi-shop me-1"></i> Vendor Manage
							</h6>
						</li>

						<li><a class="dropdown-item" href="<%=ORSView.VENDOR_CTL%>">
								<i class="bi bi-plus-circle me-2 text-success"></i> Add Vendor
						</a></li>

						<li><a class="dropdown-item"
							href="<%=ORSView.VENDOR_LIST_CTL%>"> <i
								class="bi bi-shop me-2 text-success"></i> Vendor List
						</a></li> --%>
				<!--   ------------------------------library----------------------------------  -->
				<%-- <li>
							<h6 class="dropdown-header text-uppercase text-info small">
								<i class="bi bi-building me-1"></i> Library Manage
							</h6>
						</li>

						<li><a class="dropdown-item" href="<%=ORSView.LIBRARY_CTL%>">
								<i class="bi bi-plus-circle me-2 text-success"></i> Add Library
						</a></li>

						<li><a class="dropdown-item"
							href="<%=ORSView.LIBRARY_LIST_CTL%>"> <i
								class="bi bi-building me-2 text-success"></i> Library List
						</a></li> --%>
				...
				<%-- <!--Exam module  -->
						...
						<li>
							<h6 class="dropdown-header text-uppercase text-info small">
								<i class="bi bi-building me-1"></i> Exam Manage
							</h6>
						</li>

						<li><a class="dropdown-item"
							href="<%=ORSView.EXAM_CTL%>"> <i
								class="bi bi-plus-circle me-2 text-success"></i> Add Exam
						</a></li>
						<li><a class="dropdown-item"
 ...
 --%>
				...
				<%-- <li>
						...
						<li><a class="dropdown-item"
							href="<%=ORSView.CUSTOMER_M_CTL%>"> <i
								class="bi bi-plus-circle me-2 text-success"></i> Add customer
						</a></li>

						<li><a class="dropdown-item"
							href="<%=ORSView.CUSTOMER_M_LIST_CTL%>"> <i
								class="bi bi-shield-check me-2 text-success"></i> customer List
						</a></li>
				...
				<%-- 
							...
							<h6 class="dropdown-header text-uppercase text-info small">
								<i class="bi bi-office me-1"></i> Employee
							</h6>
						</li>

						<li><a class="dropdown-item"
							href="<%=ORSView.EMP_CTL%>"> <i
								class="bi bi-plus-circle me-2 text-success"></i> Add emp
						</a></li>
				...
				<li><a class="dropdown-item" href="<%=ORSView.HOTEL_LIST_CTL%>">
						<i class="bi bi-building me-2 text-success"></i> Hotel List
				</a></li>
				...
				<li><a class="dropdown-item" href="<%=ORSView.STUDENT_M_CTL%>">
						<i class="bi bi-plus-circle me-2 text-success"></i> Add Student
				</a></li>

				<li><a class="dropdown-item"
					href="<%=ORSView.STUDENT_M_LIST_CTL%>"> <i
						class="bi bi-person me-2 text-success"></i> Student List
				</a></li>
