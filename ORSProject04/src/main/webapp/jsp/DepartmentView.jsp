...
<jsp:useBean id="bean" class="com.sunilos.p4.bean.DepartmentBean"
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-header text-white border-0 py-3 px-4"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit Department" : "Add Department"%>
			</h5>
		</div>
		...
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.DEPARTMENT_CTL%>" method="POST">
				...
				<div class="mb-3">
					...
					</label> <input type="text" name="departmentName" class="form-control"
				...
				<div class="mb-3">
					<label class="form-label fw-semibold"> HOD Name <span
						class="text-danger">*</span>
					</label> <input type="text" name="hodName" class="form-control"
						value="<%=DataUtility.getStringData(bean.getHodName())%>">

					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("hodName", request)%>
					</div>
				</div>

				<div class="mb-3">
					<label class="form-label fw-semibold"> Total Faculty <span
						class="text-danger">*</span>
					</label> <input type="text" name="totalFaculty" class="form-control"
						value="<%=DataUtility.getStringData(bean.getTotalFaculty())%>">

					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("totalFaculty", request)%>
					</div>
				</div>
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					<a href="<%=ORSView.DEPARTMENT_LIST_CTL%>"
