<%@page import="com.sunilos.p4.ctl.VendorListCtl"%>
<%@page import="com.sunilos.p4.ctl.BaseCtl"%>
<%@page import="com.sunilos.p4.ctl.ORSView"%>
<%@page import="com.sunilos.p4.util.ServletUtility"%>
<%@page import="com.sunilos.p4.bean.VendorBean"%>
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-shop me-2"></i> Vendor List
			</h5>

			<div class="d-flex gap-2">

				<a href="<%=ORSView.VENDOR_REPORT_CTL%>" target="_blank"
					class="btn btn-sm btn-warning fw-semibold"> <i
					class="bi bi-file-earmark-pdf me-1"></i> Print PDF
				</a> <a href="<%=ORSView.VENDOR_REPORT_CTL%>?type=doc" target="_blank"
					...
					class="bi bi-plus-circle me-1"></i> Add Vendor
				</a>
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td class="fw-semibold"><%=bean.getVendorName()%></td>
							...
							<td><a href="VendorCtl?id=<%=bean.getId()%>"
