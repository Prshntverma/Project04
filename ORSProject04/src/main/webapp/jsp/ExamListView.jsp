...
<%@page import="com.sunilos.p4.bean.ExamBean"%>
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-journal-text me-2"></i> Exam List
			</h5>

			<div class="d-flex gap-2">

				<a href="<%=ORSView.EXAM_CTL%>"
		...
		<form action="<%=ORSView.EXAM_LIST_CTL%>" method="POST">
			...
			<div
				...
				<input type="text"
					...
					value="<%=ServletUtility.getParameter("examName", request)%>">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<a href="<%=ORSView.EXAM_CTL%>?id=<%=bean.getId()%>"
