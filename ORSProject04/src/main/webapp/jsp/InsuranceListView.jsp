<%@page import="com.sunilos.p4.ctl.InsuranceListCtl"%>
  ...
  <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
    ...
    <div class="card-header text-white border-0 py-3 px-4 d-flex justify-content-between align-items-center"
      ...
      <h5 class="mb-0 fw-bold">
        <i class="bi bi-shield-check me-2"></i> Insurance List
      </h5>

      <div class="d-flex gap-2">
        <a href="<%=ORSView.INSURANCE_CTL%>" class="btn btn-sm btn-light text-primary fw-semibold">
    ...
    <form action="<%=ORSView.INSURANCE_LIST_CTL%>" method="POST">
      ...
      <div class="p-3 bg-light border-bottom d-flex flex-wrap gap-2 align-items-center">
        ...
        <input type="text"
               ...
               placeholder="Search Policy Holder Name"
               value="<%=ServletUtility.getParameter("policyHolderName", request)%>">
        ...
        <input type="text"
               ...
               value="<%=ServletUtility.getParameter("policyType", request)%>">
        ...
        <button type="submit"
                ...
                onclick="return confirm('Delete selected insurance records?')">
        ...
        <table class="table table-hover align-middle mb-0">
          ...
          %>
            ...
            <tr>
              ...
              <td class="fw-semibold"><%=bean.getPolicyHolderName()%></td>

              <td><%=bean.getPolicyType()%></td>

              <td><%=bean.getPremiumAmount()%></td>

              <td><%=DataUtility.getDateString(bean.getExpiryDate())%></td>

              <td>
                <a href="<%=ORSView.INSURANCE_CTL%>?id=<%=bean.getId()%>"
