...
<jsp:useBean id="bean"
	class="com.sunilos.p4.bean.CollegeRecordBean"
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-header text-white border-0 py-3 px-4"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit College Record" : "Add College Record"%>
			</h5>
		</div>
		...
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.COLLEGE_RECORD_CTL%>" method="POST">
				...
				<div class="mb-3">
					...
					<input type="text"
						name="collegeName"
						class="form-control"
						value="<%=DataUtility.getStringData(bean.getCollegeName())%>">
				...
				<div class="mb-3">
					...
					<input type="text"
						name="university"
						class="form-control"
						value="<%=DataUtility.getStringData(bean.getUniversity())%>">

					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("university", request)%>
					</div>
				</div>
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					<a href="<%=ORSView.COLLEGE_RECORD_LIST_CTL%>"
