	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-header text-white border-0 py-3 px-4"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit Hotel" : "Add Hotel"%>
			</h5>
		...
		<div class="card-body px-4 py-4">
			...
			<form name="hotelForm" action="<%=ORSView.HOTEL_CTL%>" method="POST">
				...
				<div class="mb-3">
					...
					<label class="form-label fw-semibold"> Hotel Name <span
						class="text-danger">*</span>
					</label> <input type="text" name="hotelName" class="form-control"
						value="<%=DataUtility.getStringData(bean.getHotelName())%>">

					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("hotelName", request)%>
					</div>
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					<a href="HotelListCtl?id=0" class="btn btn-secondary ms-auto">
