...
<%@page import="com.sunilos.p4.bean.CollegeRecordBean"%>
...
Iterator<CollegeRecordBean> it = list.iterator();
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-bank2 me-2"></i> College Record List
			</h5>

			<div class="d-flex gap-2">

				<a href="<%=ORSView.COLLEGE_RECORD_CTL%>"
		...
		<form action="<%=ORSView.COLLEGE_RECORD_LIST_CTL%>" method="POST">
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						while (it.hasNext()) {
							...
							CollegeRecordBean bean = it.next();
						%>
						...
						<tr>
							...
							<td>
								...
								<a href="<%=ORSView.COLLEGE_RECORD_CTL%>?id=<%=bean.getId()%>"
