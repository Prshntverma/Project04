...
<%@page import="com.sunilos.p4.bean.ServiceBean"%>
...
<div class="container-fluid px-4 py-4" style="max-width: 1100px;">
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<form action="<%=ORSView.SERVICE_LIST_CTL%>" method="POST">
			...
			<div
				...
				<input type="text" name="serviceName"
					...
					value="<%=ServletUtility.getParameter("serviceName", request)%>">
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td class="fw-semibold"><%=bean.getServiceName()%></td>
