<%@page import="com.sunilos.p4.ctl.StudentMCtl"%>
...
<jsp:useBean id="bean" class="com.sunilos.p4.bean.StudentMBean"
...
<div class="container py-4" style="max-width: 640px;">
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-body px-4 py-4">
			...
			<form action="StudentMCtl" method="POST">
				...
				<div class="mb-4">
					...
					<label class="form-label fw-semibold"> Course <span
						class="text-danger">*</span>
					</label> <input type="text" name="course" class="form-control"
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					<a href="StudentMListCtl?id=0" class="btn btn-secondary ms-auto">
