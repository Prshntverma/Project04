<%@page import="com.sunilos.p4.ctl.DoctorCtl"%>
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-header text-white border-0 py-3 px-4"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit Doctor" : "Add Doctor"%>
			</h5>
		...
		<div class="card-body px-4 py-4">
			...
			<form action="DoctorCtl" method="POST">
				...
				<div class="mb-3">
					...
					<label class="form-label fw-semibold"> Specialization <span
						class="text-danger">*</span>
					</label> <input type="text" name="specialization" class="form-control"
				...
				<div class="mb-3">
					...
					<label class="form-label fw-semibold"> Experience <span
						class="text-danger">*</span>
					</label> <input type="text" name="experience" class="form-control"
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					<a href="DoctorListCtl?id=0" class="btn btn-secondary ms-auto">
