...
<%@page import="com.sunilos.p4.ctl.OrderListCtl"%>
...
<%@page import="com.sunilos.p4.bean.OrderBean"%>
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<div class="d-flex gap-2">
				...
				<a href="<%=ORSView.ORDER_REPORT_CTL%>" target="_blank"
					class="btn btn-sm btn-warning fw-semibold"> <i
					class="bi bi-file-earmark-pdf me-1"></i> Print PDF
				</a> <a href="<%=ORSView.ORDER_REPORT_CTL%>?type=doc" target="_blank"
					...
					class="bi bi-plus-circle me-1"></i> Add Order
				</a>
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="OrderCtl?id=<%=bean.getId()%>"
