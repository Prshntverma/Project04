<%@page import="com.sunilos.p4.ctl.BranchListCtl"%>
  ...
  <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
    ...
    <div class="card-header text-white border-0 py-3 px-4 d-flex justify-content-between align-items-center"
      ...
      <h5 class="mb-0 fw-bold">
        <i class="bi bi-building me-2"></i> Branch List
      </h5>

      <div class="d-flex gap-2">
        <a href="<%=ORSView.BRANCH_CTL%>" class="btn btn-sm btn-light text-primary fw-semibold">
    ...
    <form action="<%=ORSView.BRANCH_LIST_CTL%>" method="POST">
      ...
      <div class="p-3 bg-light border-bottom d-flex flex-wrap gap-2 align-items-center">
        ...
        <button type="submit"
                ...
                onclick="return confirm('Delete selected branches?')">
        ...
        <table class="table table-hover align-middle mb-0">
          ...
          %>
            ...
            <tr>
              ...
              <td class="fw-semibold"><%=bean.getBranchName()%></td>
              ...
              <td>
                <a href="<%=ORSView.BRANCH_CTL%>?id=<%=bean.getId()%>"
