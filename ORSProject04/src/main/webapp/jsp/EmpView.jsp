...
<jsp:useBean id="bean" class="com.sunilos.p4.bean.EmpModelBean"
			...
			<form action="EmpCtl" method="POST">
				...
				<div class="mb-4">
					...
					<label class="form-label fw-semibold"> Joining Date <span
						class="text-danger">*</span>
					</label> <input type="date" name="joiningDate" class="form-control"
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					<a href="EmpListCtl?id=0" class="btn btn-secondary ms-auto"> <i
