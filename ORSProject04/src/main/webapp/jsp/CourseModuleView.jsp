<%@page import="com.sunilos.p4.ctl.CourseModuleCtl"%>
<%@page import="com.sunilos.p4.ctl.BaseCtl"%>
<%@page import="com.sunilos.p4.util.DataUtility"%>
<%@page import="com.sunilos.p4.util.ServletUtility"%>
<%@page import="com.sunilos.p4.ctl.ORSView"%>
<jsp:useBean id="bean" class="com.sunilos.p4.bean.CourseModuleBean"
...
<div class="container py-4" style="max-width: 640px;">
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.COURSE_MODULE_CTL%>" method="POST">
				...
				<div class="mb-3">
					...
					<label class="form-label fw-semibold"> Duration <span
						class="text-danger">*</span>
					</label> <input type="text" name="duration" class="form-control"
				...
				<div class="mb-3">
					...
					<label class="form-label fw-semibold"> Fees <span
						class="text-danger">*</span>
					</label> <input type="text" name="fees" class="form-control"
				...
				<div class="mb-4">
					...
					<label class="form-label fw-semibold"> Trainer Name <span
						class="text-danger">*</span>
					</label> <input type="text" name="trainerName" class="form-control"
