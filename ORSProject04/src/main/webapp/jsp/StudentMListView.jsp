```jsp
<%@page import="com.sunilos.p4.ctl.StudentMListCtl"%>
<%@page import="com.sunilos.p4.ctl.BaseCtl"%>
<%@page import="com.sunilos.p4.ctl.ORSView"%>
<%@page import="com.sunilos.p4.util.ServletUtility"%>
<%@page import="com.sunilos.p4.bean.StudentMBean"%>
...
Iterator<StudentMBean> it = list.iterator();
...
<div class="container-fluid px-4 py-4" style="max-width: 1100px;">
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<form action="<%=ORSView.STUDENT_M_LIST_CTL%>" method="POST">
			...
			<div
				...
				<input type="text" name="name" class="form-control form-control-sm"
					style="max-width: 250px;" placeholder="Search by Student Name"
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="StudentMCtl?id=<%=bean.getId()%>"
