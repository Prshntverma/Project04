<%@page import="com.sunilos.p4.ctl.CustomerMListCtl"%>
<%@page import="com.sunilos.p4.ctl.BaseCtl"%>
<%@page import="com.sunilos.p4.ctl.ORSView"%>
<%@page import="com.sunilos.p4.util.ServletUtility"%>
<%@page import="com.sunilos.p4.bean.CustomerMBean"%>
...
Iterator<CustomerMBean> it = list.iterator();
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<%-- <div class="d-flex gap-2">
				<a href="<%=ORSView.CUSTOMER_REPORT_CTL%>" target="_blank"
					class="btn btn-sm btn-warning fw-semibold">
					<i class="bi bi-file-earmark-pdf me-1"></i> Print PDF
				</a>

				<a href="<%=ORSView.CUSTOMER_REPORT_CTL%>?type=doc"
		...
		<form action="<%=ORSView.CUSTOMER_M_LIST_CTL%>" method="POST">
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td class="fw-semibold"><%=bean.getCustomerName()%></td>
							...
							<td>
								<a href="CustomerMCtl?id=<%=bean.getId()%>"
