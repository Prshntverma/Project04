<%@page import="com.sunilos.p4.ctl.LibraryListCtl"%>
<%@page import="com.sunilos.p4.ctl.BaseCtl"%>
<%@page import="com.sunilos.p4.ctl.ORSView"%>
<%@page import="com.sunilos.p4.util.ServletUtility"%>
<%@page import="com.sunilos.p4.bean.LibraryBean"%>
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-building me-2"></i> Library List
			</h5>

			<div class="d-flex gap-2">

				<a href="<%=ORSView.LIBRARY_REPORT_CTL%>" target="_blank"
					class="btn btn-sm btn-warning fw-semibold"> <i
					class="bi bi-file-earmark-pdf me-1"></i> Print PDF
				</a> <a href="<%=ORSView.LIBRARY_REPORT_CTL%>?type=doc" target="_blank"
					...
					class="bi bi-plus-circle me-1"></i> Add Library
				</a>
		...
		<form action="<%=ORSView.LIBRARY_LIST_CTL%>" method="POST">
			...
			<div
				...
				<input type="text" name="libraryName"
					...
					value="<%=ServletUtility.getParameter("libraryName", request)%>">
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td class="fw-semibold"><%=bean.getLibraryName()%></td>

							<td><%=bean.getLibraryAddress()%></td>

							<td><%=bean.getTotalBooks()%></td>

							<td><%=bean.getContactNo()%></td>

							<td><a href="LibraryCtl?id=<%=bean.getId()%>"
