...
<%@page import="com.sunilos.p4.bean.DepartmentBean"%>
		...
		<form action="<%=ORSView.DEPARTMENT_LIST_CTL%>" method="post">
			...
			<div class="p-3 bg-light border-bottom d-flex flex-wrap gap-2">
				...
				<input type="text"
					...
					value="<%=ServletUtility.getParameter("hodName", request)%>">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<a href="<%=ORSView.DEPARTMENT_CTL%>?id=<%=bean.getId()%>"
