<%@page import="com.sunilos.p4.ctl.VendorCtl"%>
<%@page import="com.sunilos.p4.ctl.BaseCtl"%>
<%@page import="com.sunilos.p4.util.DataUtility"%>
<%@page import="com.sunilos.p4.util.ServletUtility"%>

<jsp:useBean id="bean" class="com.sunilos.p4.bean.VendorBean"
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-header text-white border-0 py-3 px-4"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit Vendor" : "Add Vendor"%>
			</h5>
		...
		<div class="card-body px-4 py-4">
			...
			<form action="VendorCtl" method="POST">
				...
				<div class="mb-3">
					...
					</label> <input type="text" name="vendorName" class="form-control"
				...
				<div class="mb-3">
					...
					<label class="form-label fw-semibold"> Mobile Number <span
						class="text-danger">*</span>
					</label> <input type="text" name="mobileNo" class="form-control"
				...
				<div class="mb-4">
					...
					<label class="form-label fw-semibold"> Service Type <span
						class="text-danger">*</span>
					</label> <input type="text" name="serviceType" class="form-control"
						value="<%=DataUtility.getStringData(bean.getServiceType())%>">
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					<a href="VendorListCtl?id=0" class="btn btn-secondary ms-auto">
