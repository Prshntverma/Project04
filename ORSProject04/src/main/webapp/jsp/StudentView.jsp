...
<jsp:useBean id="bean" class="com.sunilos.p4.bean.StudentBean"
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-body px-4 py-4">
			...
			<form action="StudentCtl" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">College <span
				...
				<div class="mb-4">
					<label class="form-label fw-semibold">Email ID <span
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					<a href="<%=ORSView.STUDENT_LIST_CTL%>"
